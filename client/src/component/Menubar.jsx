...
const Menubar = () => {
    ...
    const {userData,BASE_URL,setIsLoggedIn,setUserData} = useContext(AppContext);
    ...
    return (
        <nav className="navbar bg-white px-5 py-4 d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center gap-2">
                ...
                <span className="fw-bold fs-4 text-dark">SafeLock</span>
            </div>
            ...
            {userData ? (
                ...
                <div className="btn btn-outline-dark rounded-pill px-3" onClick={() =>navigate("/login")}>
                    Giriş Yap <i className="bi bi-arrow-right ms-2"></i>
                </div>
            )}
